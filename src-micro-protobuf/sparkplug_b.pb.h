...
#ifndef PB_ORG_ECLIPSE_TAHU_PROTOBUF_SPARKPLUG_B_SPARKPLUG_B_PB_H_INCLUDED
#define PB_ORG_ECLIPSE_TAHU_PROTOBUF_SPARKPLUG_B_SPARKPLUG_B_PB_H_INCLUDED
#include <pb.h>
...
/* Enum definitions */
typedef enum _org_eclipse_tahu_protobuf_DataType {
